...
public class Sprite extends GameObject implements Renderable
{
	...
	public void setTexture(String textureName) {
		mTexture = TextureManager.getInstance().getLoaded(textureName);
		updateRenderParams();
	}
	public void setTextureAndSize(Texture texture) {
		mTexture = texture;
		mSize.set(mTexture.getWidth(), mTexture.getHeight());
		updateRenderParams();
	}
	public void setTextureAndSize(String textureName) {
		mTexture = TextureManager.getInstance().getLoaded(textureName);
		mSize.set(mTexture.getWidth(), mTexture.getHeight());
		updateRenderParams();
	}
